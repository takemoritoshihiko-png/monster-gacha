...
function SpendForm({ available, spending, onSpend }) {
  ...
  const options = [
    { amount: 10000000000, label: "🎁 Amazonギフトカード 1,000円分", desc: "100億円の資産を使用", maxUses: 20, img: "assets/ui/spend-gift.webp" },
    { amount: 50000000000, label: "🍽️ 家族で食事ごちそう 5,000円分", desc: "500億円の資産を使用", maxUses: 6, img: "assets/ui/spend-meal.webp" },
    { amount: 250000000000, label: "🏠 家庭用の家具サポート 25,000円分", desc: "2,500億円の資産を使用", maxUses: 2, img: "assets/ui/spend-furniture.webp" },
    { amount: 500000000000, label: "✈️ 国内旅費サポート 50,000円分", desc: "5,000億円の資産を使用", maxUses: 1, img: "assets/ui/spend-travel.webp" },
  ];
